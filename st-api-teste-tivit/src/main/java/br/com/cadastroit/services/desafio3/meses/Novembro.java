...
public class Novembro extends AbstractDataValues {
	...
	public Map<String, List<Double>> valuesPerDay() {
		...
		return Map.ofEntries(
				...
				Map.entry("07", List.of(15.23, 22.56, 37.34, 67.12)),
				Map.entry("08", List.of(13.45, 18.12, 31.87, 59.89)),
				...
				Map.entry("13", List.of(13.90, 21.12, 39.01, 62.90)),
				...
				Map.entry("21", List.of(12.34, 18.23, 31.83, 58.34)),
				...
				Map.entry("30", List.of(14.32, 20.78, 38.45, 67.89)),
