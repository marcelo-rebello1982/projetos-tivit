...
public class Marco extends AbstractDataValues {
	...
	public Map<String, List<Double>> valuesPerDay() {
		...
		return Map.ofEntries(
				Map.entry("01", generateValues(8 + random.nextInt(7))),
				...
				Map.entry("06", generateValues(8 + random.nextInt(7))),
				Map.entry("07", generateValues(2 + random.nextInt(7))),
				Map.entry("08", generateValues(3 + random.nextInt(7))),
				Map.entry("09", generateValues(5 + random.nextInt(7))),
				Map.entry("10", generateValues(6 + random.nextInt(7))),
				Map.entry("11", generateValues(4 + random.nextInt(7))),
				Map.entry("12", generateValues(2 + random.nextInt(7))),
				Map.entry("13", generateValues(3 + random.nextInt(7))),
				...
				Map.entry("30", generateValues(4 + random.nextInt(7))),
				Map.entry("31", generateValues(4 + random.nextInt(7)))
				);
	}
}
